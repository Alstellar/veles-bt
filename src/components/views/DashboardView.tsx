      ...
      points: [
        {
          ...
          text: 'Убраны лишние пары (не USDT) из вкладок "Активы" и "Бектесты".'
        },
        {
          icon: <IconTable size={16} />,
          text: 'Добавлены новые фильтры активов для вкладок "Активы" и "Бектесты".'
        },
        {
          icon: <IconAdjustments size={16} />,
          text: 'Переработана библиотека индикаторов: теперь индикаторы с периодами задаются аналогично Veles.'
        },
        {
          icon: <IconBrain size={16} />,
          text: 'Добавлены 3 новых индикатора: "VMC Wave Trend", "VMC Divergence", "VMC Money Flow".'
        }
      ]
    },
    {
      ...
      points: [
        ...
        {
          icon: <IconTable size={16} />,
          text: 'Добавлена вкладка "Бектесты": формирование очереди тестов из шаблонов и списка активов.'
        },
        {
          icon: <IconAdjustments size={16} />,
          text: 'Добавлены новые индикаторы: "Vortex", "Детектор скачков объема" и "Тренд свечей"'
        },
        {
          icon: <IconLock size={16} />,
          text: 'Добавлена поддержка дополнительного домена: https://ru.veles.finance/.'
        }
      ]
    },
    {
